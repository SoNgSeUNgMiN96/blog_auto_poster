...
class Settings(BaseSettings):
    ...
    prompt_template: str = Field(
        default=(
            ...
            "[기본정보 규칙] 도입부 초반에 공개일/러닝타임/등장인물/감독/장르를 자연스럽게 언급해줘. "
            "[가독성 규칙] 문장은 짧고 리듬감 있게. 문장 끝(.,!,?) 뒤에는 자연 줄바꿈. 필요하면 Markdown(굵게/리스트/인용) 사용. "
            "핵심 포인트 키워드는 문맥에 맞게 **굵게** 강조해줘. "
            ...
            "정보: 제목={title}, 플랫폼={providers_ko}, 주요플랫폼={primary_provider_ko}, 공개일={release_date}, 러닝타임={runtime}, 등장인물={cast}, 감독={director}, "
            "줄거리={overview}, 원본줄거리={original_overview}, 보강줄거리={enriched_overview}, 컨텍스트={overview_context}, 평점={rating}, 장르={genres}, 연도={year}. "
